	...
	const categories = [
		{
			...
			links: [
				...
				{ href: '/enlisted-esp/', labelKey: 'homeSeo.linkEsp' },
				{ href: '/enlisted-aimbot/', labelKey: 'homeSeo.linkAimbot' },
				{ href: '/enlisted-vehicles/', labelKey: 'homeSeo.linkRadar' },
			],
		},
		{
			...
			links: [
				...
				{ href: '/enlisted-hacks/', labelKey: 'homeSeo.linkUndetected' },
		...
		},
		{
			...
			links: [
				...
				{ href: '/enlisted-hacks/', labelKey: 'homeSeo.linkEnlistedCheats' },
				{ href: '/features/', labelKey: 'homeSeo.linkAllFeatures' },
			],
		},
		{
