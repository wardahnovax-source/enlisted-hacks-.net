...
export const seoLandingPages = [
	{ label: fillBrandTokens('{game} hacks'), href: '/enlisted-hacks/' },
	{ label: fillBrandTokens('{primaryKeyword}'), href: '/enlisted-hacks/' },
	{ label: fillBrandTokens('{game} esp'), href: '/enlisted-esp/' },
	{ label: fillBrandTokens('{game} aimbot'), href: '/enlisted-aimbot/' },
	{ label: fillBrandTokens('{game} setup'), href: '/setup/' },
	{ label: fillBrandTokens('Undetected {primaryKeyword}'), href: '/enlisted-hacks/' },
	{ label: fillBrandTokens('{game} wallhack'), href: '/enlisted-esp/' },
	{ label: fillBrandTokens('{game} vehicle ESP'), href: '/enlisted-vehicles/' },
] as const;

export const mainNav = [
	{ label: 'Home', href: '/' },
	{ label: 'Hacks', href: '/enlisted-hacks/' },
...
export const footerExplore = [
	...
	{ label: fillBrandTokens('{game} hacks pillar'), href: '/enlisted-hacks/' },
	{ label: fillBrandTokens('Live {game} status'), href: '/updates/' },
	{ label: fillBrandTokens('{game} ESP overlays'), href: '/enlisted-esp/' },
	{ label: fillBrandTokens('{game} Aimbot controls'), href: '/enlisted-aimbot/' },
	{ label: fillBrandTokens('{game} vehicle ESP'), href: '/enlisted-vehicles/' },
...
export const homeFaqs: readonly FaqItem[] = [
	faq({
		...
		answer:
			'{brand} is an undetected {primaryKeyword} package for Enlisted on Windows PC. It includes ESP wallhack, 2D radar, and aimbot controls, with {antiCheat} maintenance and setup support.',
		slug: 'what-are-enlisted-hacks',
	...
	faq({
		...
		slug: 'are-enlisted-hacks-undetected-in-2026',
	...
	faq({
		question: 'Does this work in squad battles and campaign missions?',
		answer:
			'Yes. ESP, radar, and aimbot are built for {game} raid flow — reading enemy soldiers and AI soldiers, spotting loot, and staying aware near extracts.',
		slug: 'pmc-raids-and-scav-runs',
		seoTitle: 'PMC Raid and Scav Support | FAQ',
		seoDescription:
			'{brand} works in squad battles and campaign missions — ESP, radar, and aimbot for Windows PC.',
	}),
	faq({
	...
	faq({
		question: 'Where do I check updates after an Enlisted or {antiCheat} patch?',
		answer:
			'Maintenance notes are posted on the Status page when an Enlisted or {antiCheat} update affects the package. That is the fastest place to confirm whether a new {brand} build is live.',
...
export const seoFaqs: readonly FaqItem[] = [
	...
	faq({
		...
		answer:
			'A {game} wallhack is an ESP overlay that shows enemy soldiers, AI soldiers, and loot through walls. {brand} includes distance readouts, extract cues, and toggleable categories.',
		slug: 'what-is-a-enlisted-wallhack',
		seoTitle: 'What Is a {game} Wallhack? | FAQ',
		seoDescription:
			'A {game} wallhack is ESP that reveals enemy soldiers, AI soldiers, and loot through walls — with distance, extracts, and category toggles.',
	}),
	faq({
		...
		slug: 'does-enlisted-hacks-include-radar-hack',
	...
	faq({
		...
		slug: 'eac-anti-cheat-and-enlisted-hacks',
	...
	faq({
		...
		slug: 'buy-undetected-enlisted-hacks-windows-pc',
...
export const customerReviews = [
	reviewMeta({
		handle: 'xKrypt0_EFT',
		rating: 5,
		text: 'Soft aim in Enlisted Hacks feels smooth on Customs. The menu took a few minutes to learn. After that, raids felt easy.',
		short: 'Soft aim in Enlisted Hacks feels smooth on Customs.',
	...
	reviewMeta({
		handle: 'buildsR4K',
		rating: 4,
		text: 'ESP boxes help on Scav runs. You can see who is holding a hallway before you push. Still worth the price for Enlisted Hacks.',
		short: 'ESP boxes help on Scav runs. Still worth the price for Enlisted Hacks.',
		slug: 'enlisted-esp-scav-run-review-buildsr4k',
	...
	reviewMeta({
		handle: 'dma_wizard',
		rating: 5,
		text: 'I moved to Enlisted Hacks this wipe. Setup was simple. It stayed up after the last Easy Anti-Cheat update when my old cheat failed. Lifetime was a good buy.',
		short: 'Enlisted Hacks stayed up after the last Easy Anti-Cheat update. Lifetime was a good buy.',
	...
	reviewMeta({
		...
		rating: 4,
		text: 'Soft aim in Enlisted Hacks is easy to tune on PC. I changed FOV a little and it felt natural. Menu is clear enough.',
		short: 'Soft aim in Enlisted Hacks is easy to tune on PC.',
		slug: 'enlisted-soft-aim-review-ctrl-player99',
	...
	reviewMeta({
		...
		rating: 3,
		text: 'Enlisted Hacks works well once it is running. First launch was slow because Windows Defender flagged the loader. Support replied in about two hours. ESP on Woods is solid.',
	...
	reviewMeta({
		handle: 'lootGoblinx',
		rating: 5,
		text: 'Loot ESP in Enlisted Hacks pays for the monthly plan. Extract markers and distance make early raids faster.',
		short: 'Loot ESP in Enlisted Hacks pays for the monthly plan.',
		slug: 'enlisted-loot-esp-review-lootgoblinx',
	...
	reviewMeta({
		...
		rating: 4,
		text: 'I have used Enlisted Hacks since last wipe. Soft aim per weapon helps in dorms. Status updates after Easy Anti-Cheat patches could be clearer, but it came back the next day.',
		short: 'Soft aim per weapon in Enlisted Hacks helps in dorms.',
		slug: 'enlisted-soft-aim-raid-review-rankedgrind42',
	...
	reviewMeta({
		handle: 'vanLifeEFT',
		rating: 5,
		text: 'Radar in Enlisted Hacks saved me near extracts. Seeing the third party early in duos is huge. Boxes plus radar look clean.',
		short: 'Radar in Enlisted Hacks saved me near extracts.',
		slug: 'enlisted-vehicles-review-vanlifeeft',
	...
	reviewMeta({
		handle: 'patchDayMike',
		rating: 4,
		text: 'Most cheats go down on patch day. Enlisted Hacks posted on the status page within a few hours and was back the next morning. My old tool left me waiting for days.',
		short: 'Enlisted Hacks was back the next morning after a patch.',
		slug: 'enlisted-eac-update-review-patchdaymike',
	...
	reviewMeta({
		handle: 'snipezOnly_',
		rating: 5,
		text: 'Bolt-action soft aim plus ESP in Enlisted Hacks is excellent for long shots. Simple and strong.',
		short: 'Bolt-action soft aim plus ESP in Enlisted Hacks is excellent.',
		slug: 'enlisted-sniper-soft-aim-review-snipezonly',
