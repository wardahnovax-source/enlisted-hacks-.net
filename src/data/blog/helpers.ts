...
const imageMap: Record<BlogImageKey, string> = {
	hero: enlistedImages.espWallhack,
	espWallhack: enlistedImages.espWallhack,
	aimbotCombat: enlistedImages.aimbotCombat,
	aimbotSkeleton: enlistedImages.aimbotSkeleton,
	squadFight: enlistedImages.aimbotCombat,
	headerArt: enlistedImages.playerEsp,
	cheatsPackage: enlistedImages.espWallhack,
	playerEsp: enlistedImages.playerEsp,
	rebootFight: enlistedImages.aimbotCombat,
	battleRoyaleCombat: enlistedImages.cheatsCombat,
	battleRoyaleIslandMap: enlistedImages.espWallhack,
};

const FALLBACK_BLOG_IMAGE = enlistedImages.espWallhack;
...
export function getBlogSitemapEntriesForLocale(locale: LocaleCode) {
	...
	for (const post of blogPosts) {
		...
		const isProductPost = /Enlisted Hacks|Aimbot|ESP|Undetected|Comparisons/i.test(post.category);
		entries.push({
