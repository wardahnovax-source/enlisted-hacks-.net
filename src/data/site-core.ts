...
export const productInfo = {
	...
	features: {
		esp: [
			'Enemy soldier ESP / wallhack',
			'Skeleton overlay through terrain',
			'Health and squad status bars',
			'Distance readouts',
			'Toggleable ESP categories',
			'Vehicle and tank highlights',
		],
		aimbot: [
			...
			'Hotkeys mid-battle',
			'Per-weapon class profiles',
		],
		radar: ['Vehicle ESP for tanks and aircraft', 'Adjustable range', 'Works in squad battles and campaign missions'],
		general: [
			'Streamproof mode for OBS and capture',
