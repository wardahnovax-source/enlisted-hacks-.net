 ...
 * Canonical site: https://enlistedhacks.net (matches brand.url)
 *
 * Requires DNS: CNAME `www` → `enlistedhacks.net` (proxied) AND
 * Workers custom domain `www.enlistedhacks.net` attached — otherwise
...
const CANONICAL_HOST = 'enlistedhacks.net';

/** Old apex still 301 → current canonical. */
const LEGACY_HOSTS = new Set(['bestenlistedcheats.com', 'www.bestenlistedcheats.com']);
