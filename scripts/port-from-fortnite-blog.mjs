#!/usr/bin/env node
/**
 * Ports the 8 posts from ../enlisted-blog into src/data/blog/posts.generated.ts
...
const SOURCE_DIR = join(ROOT, '..', 'enlisted-blog', 'src', 'content', 'posts');
...
for (const file of POST_FILES) {
	...
	sources.push({
		...
		intro: post.excerpt,
		keywords: [...post.tags, 'enlisted intel'],
...
const file = `/* Auto-generated by scripts/port-from-enlisted-blog.mjs — do not edit by hand. */
