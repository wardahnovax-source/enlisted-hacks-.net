...
const KW = {
	...
	cheats: 'enlisted hacks',
	hack: 'enlisted hack',
	esp: 'enlisted esp',
	wallhack: 'ESP wallhack',
	radar: 'radar hack',
	aimbot: 'enlisted aimbot',
...
export const phrases = {
	es: {
		buy: 'Comprar Enlisted Hacks', undetected: 'indetectables', maps: 'Normandy, Berlin, and Stalingrad battlefields',
		...
		legal: () => 'Contacta support@enlistedhacks.net para solicitudes legales o de soporte.',
	},
	fr: {
		buy: 'Acheter Enlisted Hacks', undetected: 'indétectables', maps: 'Normandy, Berlin, and Stalingrad battlefields',
		...
		legal: () => 'Contactez support@enlistedhacks.net pour le support ou les demandes légales.',
	},
	de: {
		buy: 'Enlisted Hacks kaufen', undetected: 'undetected', maps: 'Normandy, Berlin, and Stalingrad battlefields',
		...
		legal: () => 'support@enlistedhacks.net für Support und rechtliche Anfragen.',
	},
	pt: {
		buy: 'Comprar Enlisted Hacks', undetected: 'indetectáveis', maps: 'Normandy, Berlin, and Stalingrad battlefields',
		...
		legal: () => 'Contacte support@enlistedhacks.net para suporte ou questões legais.',
	},
	it: {
		buy: 'Acquista Enlisted Hacks', undetected: 'indetectable', maps: 'Normandy, Berlin, and Stalingrad battlefields',
		...
		legal: () => 'Contatta support@enlistedhacks.net per supporto o richieste legali.',
	},
	nl: {
		buy: 'Enlisted Hacks kopen', undetected: 'undetected', maps: 'Normandy, Berlin, and Stalingrad battlefields',
		...
		legal: () => 'support@enlistedhacks.net voor support en juridische vragen.',
	},
	pl: {
		buy: 'Kup Enlisted Hacks', undetected: 'undetected', maps: 'Normandy, Berlin, and Stalingrad battlefields',
		...
		legal: () => 'support@enlistedhacks.net w sprawach wsparcia i prawnych.',
	},
	ru: {
		buy: 'Купить Enlisted Hacks', undetected: 'undetected', maps: 'Normandy, Berlin, and Stalingrad battlefields',
		...
		legal: () => 'support@enlistedhacks.net для поддержки и юридических вопросов.',
	},
	tr: {
		buy: 'Enlisted Hacks satın al', undetected: 'undetected', maps: 'Normandy, Berlin, and Stalingrad battlefields',
		...
		legal: () => 'Destek ve yasal sorular için support@enlistedhacks.net.',
	},
	ar: {
		buy: 'اشترِ Enlisted Hacks', undetected: 'غير مكتشف', maps: 'Normandy, Berlin, and Stalingrad battlefields',
		...
		legal: () => 'support@enlistedhacks.net للدعم والطلبات القانونية.',
	},
	ja: {
		buy: 'Enlisted Hacksを購入', undetected: 'undetected', maps: 'Normandy, Berlin, and Stalingrad battlefields',
		...
		legal: () => 'サポート・法務: support@enlistedhacks.net',
	},
	ko: {
		buy: 'Enlisted Hacks 구매', undetected: 'undetected', maps: 'Normandy, Berlin, and Stalingrad battlefields',
		...
		legal: () => '지원 및 법무: support@enlistedhacks.net',
	},
	zh: {
		buy: '购买 Enlisted Hacks', undetected: 'undetected', maps: 'Normandy, Berlin, and Stalingrad battlefields',
		...
		legal: () => '支持与法务：support@enlistedhacks.net',
	},
	hi: {
		buy: 'Enlisted Hacks खरीदें', undetected: 'undetected', maps: 'Normandy, Berlin, and Stalingrad battlefields',
		...
		legal: () => 'सहायता: support@enlistedhacks.net',
	},
	id: {
		buy: 'Beli Enlisted Hacks', undetected: 'undetected', maps: 'Normandy, Berlin, and Stalingrad battlefields',
		...
		legal: () => 'support@enlistedhacks.net untuk dukungan dan legal.',
	},
	th: {
		buy: 'ซื้อ Enlisted Hacks', undetected: 'undetected', maps: 'Normandy, Berlin, and Stalingrad battlefields',
		...
		legal: () => 'support@enlistedhacks.net สำหรับการสนับสนุน',
	},
	vi: {
		buy: 'Mua Enlisted Hacks', undetected: 'undetected', maps: 'Normandy, Berlin, and Stalingrad battlefields',
		...
		legal: () => 'support@enlistedhacks.net cho hỗ trợ và pháp lý.',
	},
	uk: {
		buy: 'Купити Enlisted Hacks', undetected: 'undetected', maps: 'Normandy, Berlin, and Stalingrad battlefields',
		...
		legal: () => 'support@enlistedhacks.net для підтримки та правових питань.',
	},
	cs: {
		buy: 'Koupit Enlisted Hacks', undetected: 'undetected', maps: 'Normandy, Berlin, and Stalingrad battlefields',
		...
		legal: () => 'support@enlistedhacks.net pro podporu a právní dotazy.',
	},
	ro: {
		buy: 'Cumpără Enlisted Hacks', undetected: 'undetected', maps: 'Normandy, Berlin, and Stalingrad battlefields',
		...
		legal: () => 'support@enlistedhacks.net pentru suport și legal.',
	},
	sv: {
		buy: 'Köp Enlisted Hacks', undetected: 'undetected', maps: 'Normandy, Berlin, and Stalingrad battlefields',
		...
		legal: () => 'support@enlistedhacks.net för support och juridik.',
	},
};
