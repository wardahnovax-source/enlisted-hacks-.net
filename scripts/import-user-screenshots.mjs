...
const assetsDir =
	'C:/Users/Aman/.cursor/projects/c-Users-Aman-enlistedhacks/assets';
...
const USER_SCREENSHOTS = [
	{
		...
		file: 'enlisted-esp-player-tags.webp',
	},
	{
		source:
		...
		file: 'enlisted-wallhack-skeleton.webp',
	},
	{
		source:
		...
		file: 'enlisted-aimbot-sniper.webp',
	},
	{
		source:
		...
		file: 'enlisted-aimbot-skeleton.webp',
	},
	{
		source:
...
const REMOVE_PREFIXES = [
	'enlisted-battle-royale-combat',
	'enlisted-extract-fight',
	'enlisted-hacks-aimbot',
	'enlisted-hacks-cover',
	'enlisted-hacks-esp-wallhack',
	'enlisted-hacks-hero',
	'enlisted-hacks-logo',
	'enlisted-hacks-package',
	'enlisted-header-art',
	'enlisted-loadout-builder',
	'enlisted-player-esp',
	'enlisted-scav-run-combat',
	'enlisted-scav-run-mode',
	'enlisted-squad-fight',
	'enlisted-verdansk-map',
];

async function removeOldEnlistedImages() {
...
async function generateResponsiveVariants() {
	const heroSource = path.join(imagesDir, 'enlisted-esp-player-tags.webp');
	const heroMeta = await sharp(heroSource).metadata();

	for (const width of HERO_WIDTHS) {
		if (heroMeta.width && width > heroMeta.width) continue;
		const file = `enlisted-esp-player-tags-${width}w.webp`;
	...
	for (const { file } of USER_SCREENSHOTS) {
		if (file === 'enlisted-esp-player-tags.webp') continue;
