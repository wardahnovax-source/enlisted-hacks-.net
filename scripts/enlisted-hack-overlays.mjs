/**
 * SVG overlay generators for Enlisted hacks marketing images.
 * Composited on top of IGN Enlisted gameplay screenshots.
 */
...
export function buildOverlaySvg(width, height, preset) {
	...
	switch (preset) {
		...
		case 'loot':
			...
			body += espBox(width * 0.68, height * 0.52, width * 0.06, height * 0.08, 'objective timer · 103m', '#fbbf24');
