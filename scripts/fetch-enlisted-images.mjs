...
import { buildOverlaySvg } from './enlisted-hack-overlays.mjs';

const imagesDir = path.resolve('public/images');
const publicDir = path.resolve('public');

/** Verified IGN Enlisted screenshot CDN paths. */
...
/**
 * Enlisted hacks image pipeline:
 * 1. Download real Enlisted gameplay from IGN
 * 2. Composite ESP / aimbot / radar / mod-menu overlays for enlisted hacks marketing
 */
const KEYWORD_ASSETS = [
	{
		file: 'enlisted-hacks-hero.webp',
		url: `${ME_G}/enlisted-screenshots_wjkx.1400.jpg`,
		overlay: 'hero',
	},
	{
		file: 'enlisted-hacks-aimbot.webp',
		url: `${ME}/enlisted-screenshots_wjb1.1400.jpg`,
		overlay: 'aimbot',
	},
	{
		file: 'enlisted-hacks-esp-wallhack.webp',
		url: `${ME}/enlisted-screenshots_55fp.1400.jpg`,
		overlay: 'wallhack',
	},
	{
		file: 'enlisted-squad-fight.webp',
		url: `${ME}/enlisted-screenshots_67cp.1400.jpg`,
		overlay: 'esp',
	},
	{
		file: 'enlisted-hacks-package.webp',
		url: `${ME}/enlisted-screenshots_anf4.1400.jpg`,
		overlay: 'menu',
	},
	{
		file: 'enlisted-hacks-cover.webp',
		url: `${ME}/enlisted-screenshots_7pr8.1400.jpg`,
		overlay: 'esp',
	},
	{
		file: 'enlisted-header-art.webp',
		url: `${ME}/enlisted-screenshots_c36j.1400.jpg`,
		overlay: 'hero',
	},
	{
		file: 'enlisted-loadout-builder.webp',
		url: `${NL}/enlisted-screenshots_e5gw.1400.jpg`,
		overlay: 'menu',
	},
	{
		file: 'enlisted-battle-royale-combat.webp',
		url: `${ME}/enlisted-screenshots_4h92.1400.jpg`,
		overlay: 'esp',
	},
	{
		file: 'enlisted-extract-fight.webp',
		url: `${BR}/goulag-inside_zusa.1400.png`,
		overlay: 'extract',
	},
	{
		file: 'enlisted-player-esp.webp',
		url: `${ME}/enlisted-screenshots_rb92.1400.jpg`,
		overlay: 'esp',
	},
	{
		file: 'enlisted-scav-run-combat.webp',
		url: `${BR}/plunder_px6d.1400.png`,
		overlay: 'scav-run',
	},
	{
		file: 'enlisted-scav-run-mode.webp',
		url: `${BR}/parachuting_qhh2.1400.png`,
		overlay: 'loot',
	},
	{
		file: 'enlisted-verdansk-map.webp',
...
async function cleanImagesDir() {
	...
	for (const file of files) {
		if (file.includes('enlisted-hacks-logo')) continue;
...
async function generateBrandAssets(heroBuffer) {
	...
	await writeFile(path.join(imagesDir, 'enlisted-hacks-logo.webp'), logoBuffer);
...
for (const asset of KEYWORD_ASSETS) {
	...
	try {
		...
		saved++;
		if (asset.file === 'enlisted-hacks-hero.webp') heroBuffer = webp;
	} catch (err) {
...
console.log(`\nDone — ${saved}/${KEYWORD_ASSETS.length} Enlisted hacks images (IGN base + ESP/aimbot overlays).`);
