...
export function validateBrandPayload(body) {
	...
	const logo = assetPath(b.logo ?? '/images/enlisted-hacks-logo.webp');
	const logoRaster = assetPath(b.logoRaster ?? '/images/enlisted-hacks-logo.png');
	const defaultOgImage = assetPath(b.defaultOgImage ?? '/images/enlisted-hacks-combat.webp');
	const heroImage = assetPath(b.heroImage ?? '/images/enlisted-hero-banner.webp');
